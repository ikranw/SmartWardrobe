<script>
  ...
  function getWeather() {
    let request =
      "http://api.weatherapi.com/v1/forecast.json?key=b853acd0326a4155bde181823251710&q=Cincinnati&days=1&aqi=no&alerts=no";
      ...
      <div hidden={!isWeatherDisplayed}>
        ...
        <div>
          <a
            ...
            href="https://forecast7.com/en/39d10n84d51/cincinnati/?unit=us"
            data-label_1="CINCINNATI"
